...
135 and 49154 ports do not really give us something useful to work with, so we start with port 80.

![placeholder](http://henryval.github.io/assets/img/htb/bastard/1.png "Drupal")
...
![placeholder](http://henryval.github.io/assets/img/htb/bastard/2.png "Command execution!")
