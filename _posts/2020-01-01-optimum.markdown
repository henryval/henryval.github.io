...
![placeholder](http://henryval.github.io/assets/img/htb/optimum/1.png "HFS")
![placeholder](http://henryval.github.io/assets/img/htb/optimum/2.png "HFS")

We got a service name and version, time to look for any exploit or vulnerabilities.

![placeholder](http://henryval.github.io/assets/img/htb/optimum/3.png "searchsploit")
...
![placeholder](http://henryval.github.io/assets/img/htb/optimum/4.png "exploit")
...
![placeholder](http://henryval.github.io/assets/img/htb/optimum/5.png "http.server")

We setup local IP and listening port.

![placeholder](http://henryval.github.io/assets/img/htb/optimum/6.png "Reverse shell data")

We start our listener and execute our modified script.

![placeholder](http://henryval.github.io/assets/img/htb/optimum/7.png "reverse shell!")
...
![placeholder](http://henryval.github.io/assets/img/htb/optimum/8.png "systeminfo")

![placeholder](http://henryval.github.io/assets/img/htb/optimum/9.png "exploit-suggester")

We try first privilege escalation [exploit](https://www.exploit-db.com/exploits/41015) on the list.

![placeholder](http://henryval.github.io/assets/img/htb/optimum/11.png "CVE-2016-7255")

That first try did not work, but we don't stop there. So let's try the [next one](https://www.exploit-db.com/exploits/41020).

![placeholder](http://henryval.github.io/assets/img/htb/optimum/10.png "exploit-suggester")
...
![placeholder](http://henryval.github.io/assets/img/htb/optimum/12.png "rooted!")
